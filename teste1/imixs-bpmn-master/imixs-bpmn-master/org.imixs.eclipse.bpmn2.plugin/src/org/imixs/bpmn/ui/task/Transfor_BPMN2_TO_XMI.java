...
public class Transfor_BPMN2_TO_XMI {
    ...
    public void setUp() throws TransformerConfigurationException, SAXException {
        ...
        /* Carrega-se o ficheiro da transformação xslt, XMLToXMI.xslt, é o que contém todas as regras que permitem transformar o ficheiro xml do bpmn num ficheiro xmi com as informações da Device_Task devidamente isoladas*/
        ...
        File schemaLocation = new File(
                "C:/Users/Z1/Desktop/Tese/Experiencias_ATL/org.eclipse.bpmn2.tests/res/extensibility/BPMN20.xsd");//ficheiro schema do bpmn20 que contém toda a estrutura do bpmn,é uma espécie de modelo
    ...
    public void testTransform() throws TransformerException, SAXException, IOException {
        ...
        processDirectory(resDirecty);//esta função permite processar a transformação de bpmn2xmi e o inverso,neste caso só interessa a 1ª
